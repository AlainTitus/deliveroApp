...
export default function FormBranch({titre, headerColor, bgColor, cameraColor, buttonColor, bordColor, labelColor, checkColor, action, album, store}) {
  ...
  const validate = async () => {
    ...
    for (var i = 0; i < nbrURI; i++) {
      ...
      asset.filename = album + "_" + numCptPose + '_' + i
    ...
    <>
          <View style={[styles.container, {backgroundColor: bgColor}]}>
            ...
            <ScrollView style={styles.form}>
              ...
              <CustomInput label={"Observation"} number={20} multiline={true} h={100} labelColor={labelColor} handleInput={setAnomalie} val={anomalie} />
