...
//             <Text style={styles.textHeader} >Illégaux Perace</Text>
...
//   )
// }
export default function PeraIllegaux() {
 
  return (
    <>
      <FormIllegaux titre={"Illegaux Perace"} action={"ill_perace"} album={"IllgPerace"} store={"illperace"} headerColor= '#2e86c1' bgColor="#ebf5fb" cameraColor="#1b4f72" buttonColor="#2e86c1" bordColor="#2e86c1" labelColor="#1a5276" checkColor="#1b4f72" />
    </>
  )
}
