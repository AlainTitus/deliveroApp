import { View, Text, ScrollView, Button, StyleSheet, ToastAndroid } from 'react-native'
...
export default function FormCC() {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <Text style={{ textAlign: 'center', fontSize: 20, color: '#1f618d', fontWeight: 'bold', marginBottom: 10 }}>Collecte d'un coupe circuit</Text>
                <CustomInput
