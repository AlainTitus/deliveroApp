...
import poteaux from "../../../../datas/updatesupports.json"
...
export default function Mapcollecte() {
    ...
    const handleUpdate = (pot) => {
        navigation.navigate("anomalies", { lat: parseFloat(pot.latitude), long: parseFloat(pot.longitude), depart: pot.depart })
    }
    ...
    return (
        <View style={StyleSheet.container}>
            ...
            >
                {
                    poteaux.map((pot, index) => (
                        <Marker
                            key={index}
                            coordinate={{ latitude: parseFloat(pot.latitude), longitude: parseFloat(pot.longitude) }}
                            image={
